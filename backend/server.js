...
if (process.env.NODE_ENV === 'production') {
    ...
    const corsOptions = {
        origin: ['http://192.168.1.29:8080', 'http://localhost:8080', 'http://10.100.102.4:3000', 'http://localhost:3000', 'http://192.168.1.31:8080', 'http://10.100.102.4:8080', 'http://10.100.102.4:8081','http://10.100.102.5:8080'],
        credentials: true
    };
